...
func (fn testAttrBuilderFn) PreparePayloadAttributes(ctx context.Context, l2Parent eth.L2BlockRef, epoch eth.BlockID, l1BaseFeeFromStateless *big.Int) (attrs *eth.PayloadAttributes, err error) {
