...
contract ZkFaultDisputeGame_Test is ZkFaultDisputeGame_Init {
    ...
    function setUp() public override {
        ...
        parentGameProxy = ZkFaultDisputeGame(address(disputeGameFactory.createZkFaultDisputeGame(
        ...
        // Create a new game
        childGameProxy = ZkFaultDisputeGame(address(disputeGameFactory.createZkFaultDisputeGame(
    ...
    function testChallengeByProof() public {
        ...
        bytes memory extraData;
        ZkFaultDisputeGame invalidGameProxy = ZkFaultDisputeGame(address(disputeGameFactory.createZkFaultDisputeGame(
            GAME_TYPE, parentClaims, type(uint64).max, parentClaimBlockNumber, extraData)));
        // Challenge the game
        ...
        ZkFaultDisputeGame invalidChildGameProxy = ZkFaultDisputeGame(address(disputeGameFactory.createZkFaultDisputeGame(
