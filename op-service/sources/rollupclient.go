...
func (r *RollupClient) BatchOutputAtBlock(ctx context.Context, blockNums []uint64) ([]*eth.OutputResponse, error) {
	var result []*eth.OutputResponse
	batchCall := batching.NewIterativeBatchCall[uint64, *eth.OutputResponse](blockNums, func(block uint64) (*eth.OutputResponse, rpc.BatchElem) {
